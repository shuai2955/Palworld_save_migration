...
def replace_headers_from_target_to_source(source_json_dir, target_json_dir, source_lines, target_lines):
...
# 执行替换操作
replace_headers_from_target_to_source(source_json_dir, target_json_dir, source_lines, target_lines)
